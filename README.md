...
أضيفت طبقة المصادقة ومساحات العمل والعضويات، إلى جانب أول Translation Provider حقيقي يعمل عبر بوابة LLM على الخادم. راجع [توثيق Phase 2](web/docs/phase-2-auth-database-translation.md) قبل تشغيل migration أو إعداد بيانات الاعتماد.
