...
export default function JoinScreen() {
  ...
  const [code, setCode] = useState(typeof params.inviteCode === "string" ? params.inviteCode.toUpperCase() : "");
