...
import { getMeetingInviteRecoveryPath, meetingInviteNotFoundMessage, shouldRecoverFromMeetingInviteError } from "@/lib/meetingRecovery";
...
export default function Meeting() {
  ...
  useEffect(() => {
    if (!validInviteCode || !shouldRecoverFromMeetingInviteError(meetingDetails.error?.data?.code)) return;
